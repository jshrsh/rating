<?php
	...
	if($go)
	{
		if(isset($name) && !empty($name))
		{
			...
			$q = mysql_query($q);
			$sep = mysql_query("
				SELECT general.p_id,comment.p_id,comment.comment as comment,comment.rating as rate FROM general,comment WHERE comment.p_id = general.p_id
    ...
    <div id="templatemo_right_column">
        ...
        <div id="templatemo_menu">
            <ul>
                ...
                <li><a href="#">All Professors and Departments</a></li>
